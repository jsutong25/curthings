    ...
    <body>
        ...
        <main>
          <div class=" flex flex-row max-container h-[50vh]">
            ...
            <!-- RIGHT SIDE -->
            <div class="mt-5 px-8 py-5 border-2 border-green-nav w-fit mx-auto overflow-y-auto" style="max-height: 400px;">
              <h3 class="bold-32 font-subtitle mb-5">Booking History</h3>
              <?php
              $query =
              ...
              <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                  ...
                  <td scope="col" class="px-6 py-3 text-center gap-2">
                          <a href="profile-viewBooking.php?view=<?= $data[
                            'booking_id'
