...
if (isset($_POST['change-password'])) {
  ...
  if ($password !== $cpassword) {
    ...
    $update_pass = "UPDATE user_info SET code = $code, password = '$password', cpass = '$cpassword' WHERE email = '$email'";
      ...
      <div class="w-screen h-[50vh]">
        ...
        <div class="w-3/4 flex flex-col items-center justify-center mx-auto my-auto">
          <div class="w-full flex justify-center content-center text-green-nav rounded-[20px]">
            <h3 class="bold-40 font-subtitle mb-2 pb-5">New Password</h3>
          </div>
          ...
          <?php if (count($errors) > 0) { ?>
            ...
            <input type="password" name="password" autocomplete="off" required placeholder="Enter new password" class="border-0 border-l-4 border-green-main py-2 mb-5 bg-gray-100 rounded-none">
            
            <label for="cpassword" class="font-subtitle regular-18">Confirm password:</label>
            <input type="password" name="cpassword" autocomplete="off" required placeholder="Confirm your password" class="border-0 border-l-4 border-green-main py-2 mb-5 bg-gray-100 rounded-none">
            
            <input type="submit" name="change-password" class="btn_dark_green font-subtitle mt-5" value="Change password">
          </form>
