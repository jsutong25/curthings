...
<head>
   ...
   <body>
      ...
      <main>
        ...
        <h2 class="bold-32 font-subtitle mb-5">Bookings</h2>
        <a href="booking-history.php" class="text-green-main font-subtitle font-bold text-xl underline flex justify-end hover:text-gray-800">Booking History</a>

            <?php
            $query =
              "SELECT * FROM bookings WHERE booking_status = '0' OR payment_status = '0'";
            $result = mysqli_query($conn, $query);
            ?>
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 font-subtitle mr-5 mt-2">
              <thead class="text-xs text-white uppercase bg-green-nav">  
                <tr class="">
                  <th scope="col" class="px-6 py-3">Booking ID</th>
                  <th scope="col" class="px-6 py-3">Booking Ref #</th>
            ...
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td scope="col" class="px-6 py-3 text-center gap-2 flex">
                        <a href="edit-status-booking.php?edit=<?= $data[
                          'booking_id'
                        ...
                        <a href="view-booking.php?view=<?= $data[
                          'booking_id'
            ...
            <?php $sn++;}
               ...
               ?>
                <tr>
                    <td colspan="8">No more bookings</td>
                </tr>
            <?php
            } ?>
            </table>
