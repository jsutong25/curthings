...
if (isset($_POST['quotation_id']) && isset($_POST['status'])) {
  ...
  $updateQuery = "UPDATE quotation SET quotation_status = '$status' WHERE quotation_id = '$quotation_id'";
...
<head>
   ...
   <body>
      ...
      <main>
          ...
          <h2 class="bold-32 font-subtitle mb-5">Quotations</h2>
          <a href="quotation-history.php" class="text-green-main font-subtitle font-bold text-xl underline flex justify-end hover:text-gray-800">Quotation History</a>
            <?php
            $query = "SELECT * FROM quotation WHERE quotation_status = '0'";
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 font-subtitle mr-5">
              <thead class="text-xs text-white uppercase bg-green-nav">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3">Quotation Number</th>
