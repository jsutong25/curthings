...
<head>
   ...
   <body>
      ...
      <main>
          ...
          <h2 class="bold-32 font-subtitle mb-5">Quotation ID '<?php echo $id; ?>' - Items</h2>
            <?php
            $query = "SELECT * FROM quotation_items WHERE quotation_id = '$id'";
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 font-subtitle mr-5">
              <thead class="text-xs text-white uppercase bg-green-nav">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3">Product Color</th>
                  <th scope="col" class="px-6 py-3">Product Variation</th>
