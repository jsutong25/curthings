...
$db = $conn;
$tableName = "user_info";
$columns = ['user_id', 'name', 'email', 'is_verified', 'role'];
   ...
   <body class="">
      ...
      <aside id="default-sidebar" class="hidden sm:inline fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-green-main dark:bg-gray-800">
            ...
            <ul class="text-center space-y-2 mt-5">
                ...
                <li>
                    <a href="adminUsers.php" class="sidebar-a group bg-gray-800">
                    <svg class="sidebar-svg" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0,0,256,256">
      ...
      <main>
        <div class="p-4 sm:ml-64">
          <h2 class="bold-32 font-subtitle mb-5">Users Information</h2>
          <?php
          $query =
            "SELECT user_id, name, email, is_verified, role FROM user_info";
          ...
          <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              ...
              <td scope="col" class="px-6 py-3 text-center gap-2 flex">
                  <a href="edit-role.php?edit=<?= $data[
                    'user_id'
                  ] ?>" class="bg-yellow-600 font-subtitle px-5 py-2 rounded-lg text-white font-bold tracking-wider hover:shadow-lg hover:bg-yellow-700 hover:cursor-pointer">Edit Role</a>
              </td>
          <tr>
          <?php }
          } else {
